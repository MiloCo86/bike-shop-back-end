...
const { checkBrand, checkYear, checkPrice, checkWeight, checkStock } = require('../validations/checkBikes')
...
bikes.post("/", checkBrand, checkYear, checkPrice, checkWeight, checkStock, async (req, res) => {
